    ...
    <div class="card-box widget-user">
        <div class="col-sm-6">
            ...
            <div class="wid-u-info">
                <h4 class="m-t-0 m-b-5">Alice Losem</h4>
...
<div class="card-box">
    <button onclick="location.href = '{{url('task-nearby')}}'" class="btn btn-block btn--md btn-pink waves-effect waves-light"> Submit </button>
</div>
