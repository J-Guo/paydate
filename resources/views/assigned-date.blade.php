        ...
        <div class="card-box widget-icon">
            <div>
                ...
                <div class="wid-icon-info">
                    ...
                    <h4 class="m-t-0 m-b-5 counter">112</h4>
                    <small class="text-danger"><b>79% 5 Stars!</b></small>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="chat-conversation">
                <ul class="conversation-list nicescroll">
                    ...
                    <li class="clearfix odd">
                        <div class="chat-avatar">
                            <img src="{{asset('images/users/male-profile.jpg')}}" alt="Female">
                            <i>10:01</i>
                        </div>
                        <div class="conversation-text">
                            <div class="ctext-wrap">
                    ...
                    <li class="clearfix odd">
                        <div class="chat-avatar">
                            <img src="{{asset('images/users/male-profile.jpg')}}" alt="male">
                            <i>10:02</i>
                        </div>
                        <div class="conversation-text">
                            <div class="ctext-wrap">
